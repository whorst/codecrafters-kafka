...
func (c *ClusterMetadata) GetClusterMetadata() (error, clutser_metadata_port.ClusterMetadataRepositoryResponse) {
	...
	*/
	...
	if err != nil {
		return err, clutser_metadata_port.ClusterMetadataRepositoryResponse{}
	}
	...
	return nil, *c.ClusterMetadataRepositoryResponse
}
